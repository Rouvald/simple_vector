...
int main()
{
    ...
    // simple_vector<uint32_t> vec(5);
    // for(uint32_t index = 0 ; index < 5; ++index)
    // {
    //     vec.at(index) = index + 1;
    // }
    // print_vector(vec, "resize test 1");

    // vec.resize(2);

    // print_vector(vec, "resize test 2");

    // for (uint32_t index = 0; index < vec.capacity(); ++index)
    // {
    //     std::cout << vec.data()[index] << ' ';
    // }
    // std::cout << std::endl;

    // vec.resize(5);

    // print_vector(vec, "resize test 3");
    ...
    // print_vector(vec, "resize test 4");
